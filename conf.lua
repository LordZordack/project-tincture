function love.conf(t)
    t.identity = nil                    -- Save directory name (string)
    t.appendidentity = false            -- Search files in source directory before save directory (boolean)
    t.version = "11.4"                  -- LÖVE version this game was made for (string)
    ...
    t.window.title = "Hack-and-Slash Shooter"  -- Window title (string)
